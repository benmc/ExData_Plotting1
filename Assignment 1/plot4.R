...
png(filename="plot4.png", height=500, width=500)
par(mfcol=c(2,2))
plot(hpc$DateTime, hpc$Global_active_power, type="l", col="black", xlab="", ylab="Global Active Power", main="")
...
plot(hpc$DateTime, hpc$Voltage, type="l", col="black", xlab="datetime", ylab="Voltage", main="")

plot(hpc$DateTime, hpc$Global_reactive_power, type="l", col="black", xlab="datetime", ylab="Global_reactive_power", main="")
